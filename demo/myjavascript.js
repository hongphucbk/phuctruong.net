...
function loadXML(){
		...
		xmlhttp.onreadystatechange = function () {
			...
			if(web_current==4){
				document.getElementById("WinCC_Start").innerHTML= parseFloat(arr[0]);//arr[0];  	
				document.getElementById("WinCC_Stop").innerHTML= parseFloat(arr[1]);//arr[1];  	
				document.getElementById("Run").innerHTML= parseFloat(arr[2]);//arr[2];  	
				document.getElementById("Finish").innerHTML= parseFloat(arr[3]);//arr[3];  	
				document.getElementById("Kp1").innerHTML= parseFloat(arr[8]);//arr[8];  	//Kp1
				document.getElementById("Ti1").innerHTML= parseFloat(arr[9]);//arr[9];  	//Ti1
				document.getElementById("Td1").innerHTML= parseFloat(arr[10]);//arr[10];  	//Td1
				document.getElementById("Kp2").innerHTML= parseFloat(arr[11]);//arr[11];  	//Kp2
